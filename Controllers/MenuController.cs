...
using Proyect_Restaurante.ServicesInterfaces;
using Proyect_Restaurante.Services;


namespace Proyect_Restaurante.Controllers
{
    public class MenuController: InterfacesMenus
    {
        ...
        public void ModifyMenu(int id)
        {
            ...
            Console.Write("Nueva categoria (dejar vacío para no cambiar): ");
            string categoria = Console.ReadLine();
            if (!string.IsNullOrWhiteSpace(categoria)) menu.Category = categoria;
